...
public interface TopicService {
    ...
    List<Topic> findByParam(TopicCustom topicCustom,Integer page,Integer pageSize);
    // 获取所有 帖子数量
    ...
    // 分页 查询 未删除 的帖子列表
    List<Topic> findByPage(Topic topic,Integer page,Integer pageSize);
    // 关键字搜索帖子、分页
    List<Topic> search(String content,Integer page,Integer pageSize);
